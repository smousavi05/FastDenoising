...
% specify type of the thresholding function 
% Hard Thresholding: 'hard'
% Soft Thresholding: 'soft'
opt.thr = 'hard';

% correction factor. Higher values --> more attenuatin of noise and some part of the coda
opt.cf = 4; 
